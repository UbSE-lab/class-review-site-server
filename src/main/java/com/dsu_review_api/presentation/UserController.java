...
@Tag(name = "User API", description = "사용자 로그인, 회원가입 API 입니다.")
public class UserController {
    ...
    @PostMapping("/signin")
    @Operation(summary = "로그인 기능", description = "학생 로그인 요청입니다.")
    ...
    @PostMapping("/signup")
    @Operation(summary = "학생 회원가입", description = "학생 회원가입 요청입니다.")
