...
//        classListRepository.save(classList7);
        ...
        Class_list classList3 = Class_list.builder()
                ...
                .class_introduction(
                        "본 수업은 수강생이 기계학습 (machine learning)의 원리를 이해하고, 그 원리를 적용하여 문제를 해결함으로 기계학습 문제들을 해결하는 코딩 능력을 기를 수 있도록 한다. 또한 4차 산업혁명의 주요 부분을 차지하고 있는 소프트웨어와 기계학습을 통하여 이러한 기술 시대의 흐름에 대비한 계산적 사고력과 창의력을 향상하고, 문제 해결 역량을 갖추도록 하는것을 목표로한다.\n"
                )
                .star_lating(0L)
                .captain_image(imageList.get(2))
                .build();
        ...
        Class_list classList15 = Class_list.builder()
                ...
                .professor_prof_id(professorList.get(14))
                .class_introduction(
                "\n" +
